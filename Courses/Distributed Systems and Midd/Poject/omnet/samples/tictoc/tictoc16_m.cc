...
TicTocMsg16::TicTocMsg16(const TicTocMsg16& other) : cMessage()
{
...
void TicTocMsg16::setSource(int source_var)
{
...
void TicTocMsg16::setDestination(int destination_var)
{
...
void TicTocMsg16::setHopCount(int hopCount_var)
{
