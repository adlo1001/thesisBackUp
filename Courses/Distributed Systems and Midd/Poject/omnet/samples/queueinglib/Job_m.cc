//
// Generated file, do not edit! Created by opp_msgc 4.1 from Job.msg.
//
...
Job_Base::Job_Base(const Job_Base& other) : cMessage()
{
...
void Job_Base::setPriority(int priority_var)
{
...
void Job_Base::setTotalQueueingTime(simtime_t totalQueueingTime_var)
{
    this->totalQueueingTime_var = totalQueueingTime_var;
}
...
void Job_Base::setTotalServiceTime(simtime_t totalServiceTime_var)
{
    this->totalServiceTime_var = totalServiceTime_var;
}
...
void Job_Base::setTotalDelayTime(simtime_t totalDelayTime_var)
{
    this->totalDelayTime_var = totalDelayTime_var;
}
...
void Job_Base::setQueueCount(int queueCount_var)
{
    this->queueCount_var = queueCount_var;
}
...
void Job_Base::setDelayCount(int delayCount_var)
{
    this->delayCount_var = delayCount_var;
}
...
void Job_Base::setGeneration(int generation_var)
{
