 ...
 *     Job(const Job& other) : Job_Base(other.getName()) {operator=(other);}
 *     Job& operator=(const Job& other) {Job_Base::operator=(other); return *this;}
...
class Job_Base : public ::cMessage
{
  ...
  public:
    ...
    virtual void setTotalQueueingTime(simtime_t totalQueueingTime_var);
    virtual simtime_t getTotalServiceTime() const;
    virtual void setTotalServiceTime(simtime_t totalServiceTime_var);
    virtual simtime_t getTotalDelayTime() const;
    virtual void setTotalDelayTime(simtime_t totalDelayTime_var);
    virtual int getQueueCount() const;
    virtual void setQueueCount(int queueCount_var);
    virtual int getDelayCount() const;
    virtual void setDelayCount(int delayCount_var);
    virtual int getGeneration() const;
    virtual void setGeneration(int generation_var);
};
