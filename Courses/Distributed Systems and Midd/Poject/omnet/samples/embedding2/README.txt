...
This example shows how to embed the simulation kernel into an other program.
...
The main method is used only to set up the network topology by reading the nedfiles
and then repeatedly clall the simulateAloha method and print out the result.
