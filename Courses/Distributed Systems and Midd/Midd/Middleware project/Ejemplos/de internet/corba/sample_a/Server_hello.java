...
public class Server_hello {
	public static void main(String args[]) {
		...
		try {
			...
			//or ORB orb = ORB.init(args, properties);  to start the orb with the properties
			//      
			...
			org.omg.CORBA.Object service_ref =
				rootpoa.servant_to_reference(hello_service);
			Interface_Hello service_href =
				Interface_HelloHelper.narrow(service_ref);
			//
